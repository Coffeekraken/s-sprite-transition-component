                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          _get(
                            ...
                            "componentMount",
                            this
                          ).call(this) // create a canvas to draw in
                        ...
                        case 8:
                          ...
                          this._totalFrames =
                            this._$spriteImg.width / this.props.spriteWidth
                          this._currentFrame = 0 // init a timer to drive the animation

                          this._timer = new _STimer.default(
                            this.props.duration,
                            {
                              tickCount:
                                this.props.stillFrame || this._totalFrames
                            }
                          )
                          ...
                          this._resizeHandlerFn = (0, _debounce.default)(
                            this._resizeHandler.bind(this),
                            100
                          )
                          window.addEventListener(
                            "resize",
                            this._resizeHandlerFn
        ...
        },
        {
          ...
          value: function animateIn() {
            ...
            return new Promise(function(resolve) {
              ...
              _this3._timer.tickCount(
                _this3.props.stillFrame || _this3._totalFrames
              )
        ...
        },
        {
          ...
          value: function animateOut() {
            ...
            return new Promise(function(resolve) {
              ...
              _this4._phase = "out"
              _this4._currentFrame =
                _this4.props.stillFrame || _this4._totalFrames

              _this4._timer.tickCount(
                _this4.props.stillFrame
                  ? _this4._totalFrames - _this4.props.stillFrame
                  : _this4._totalFrames
              )

              _this4._timer.duration(
                _this4.props.outDuration || _this4.props.duration
              )
